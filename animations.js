...
(function () {
  ...
  /* Lenis теперь на lerp (см. script.js), а не duration+easing — просадка
     кадра там даёт чуть больший шаг к цели, а не скачок по кривой. Клэмп
     lagSmoothing(500, 33) был нужен именно под time-режим; в lerp-режиме
     он больше не защищает от рывков и только режет длинные кадры GSAP-таймлайнам.
     lagSmoothing(0) — как в референсе (oci.madebybuzzworthy.com). */
